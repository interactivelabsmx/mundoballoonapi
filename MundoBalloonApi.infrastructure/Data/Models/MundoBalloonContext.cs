...
public class MundoBalloonContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UserCartProduct>(entity =>
        {
            ...
            entity.Property(e => e.UserCartId).HasColumnName("user_cart_id");
        ...
        modelBuilder.Entity<UserEventCartDetail>(entity =>
        {
            ...
            entity.Property(e => e.UserEventCartDetailId).HasColumnName("user_event_cart_detail_id");
        ...
        modelBuilder.Entity<Orders>(entity =>
        {
            ...
            entity.HasIndex(e => e.PaymentId, "orders_payment_id_uindex");
