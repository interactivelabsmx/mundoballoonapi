...
public interface IUsersService
{
    ...
    Task<EventCartDetail> AddToEventCart(int productVariantId, int userEventId, decimal quantity, CancellationToken cancellationToken);
    Task<UserCart> AddToCart(string userId, string sku, decimal quantity, decimal price, int productVariantId, CancellationToken cancellationToken);
}