...
public interface IUsersService
{
    ...
    Task<ProductVariantReview> UpdateProductVariantReview(int productVariantId,int productVariantReviewId, string userId, int rating, string comments, CancellationToken cancellationToken);
    Task<bool> DeleteProductVariantReview(int productVariantReviewId,string userId, CancellationToken cancellationToken);
}